...
typealias NewsMVVMtListResult = (status: Int, newsList: Array<DestinationsListDec>, totalItems: Int) -> Unit
...
object WebServices {
    ...
    fun newsListMVVM(
        ...
        try {
            ...
            val urlString = BackendRoute.BASE_URL + BackendRoute.DESTINATIONS_MAIN
...
//                    val totalResults = response.getInt("totalResults")
                    ...
                    val array = response.getJSONArray("destinations")

                    val newsListDec = DestinationsListDec.fromJson(array, true).toTypedArray()


                    result(1, newsListDec, array.length())
